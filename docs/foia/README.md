...
| DOF/CDOT Smart Streets enforcement data (bike/bus lane camera violations, commercial fleet attribution) | `smart-streets-enforcement.md` → [`docs/outbox/2026-07-21--foia--dof--smart-streets-enforcement-data.md`](../outbox/2026-07-21--foia--dof--smart-streets-enforcement-data.md) | Ready to send — anchors verified 2026-07-21; Gmail draft prepared |
