...
*A copy of this draft has been sitting in Gmail since 2026-07-12 — this file
is now the canonical version; reconcile before sending if the Gmail copy was
edited. Rationale, narrowing strategy, and what-happens-on-receipt:
`docs/foia/cdot-bikeway-mileage-history.md`.*
