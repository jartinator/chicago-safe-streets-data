...
(function (root) {
  ...
  // One solid color per named line (spec §9) — the 14 street + 6 trail
  // roster, exactly as listed. roosevelt/vincennes are demoted to
  // connectors (spec §2) and carry no line color; 312-riverrun joined the
  // trail roster after the spec (DECISIONS.md #26).
  const LINE_COLORS = {
    // street lines
    "milwaukee":            "#1d4ed8",
    "elston":               "#ea580c",
