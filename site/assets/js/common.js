...
(function () {
  const TIER_INFO = {
    ...
    mock: "MOCK demonstration data — synthetic, generated by this project. Not real reports. " +
      "This tier exists in the vocabulary in principle; no currently-published dataset uses it.",
  ...
  const TIER_PLAIN = {
    ...
    mock: "fake demo data — not real reports (no current dataset uses this tier)",
